...
export default function Index({ auth, classes, academicYears, teachers }) {
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-bold text-2xl text-gray-800 leading-tight">Data Kelas</h2>}
        >
            <Head title="Kelas" />
                ...
                <div className="p-8">
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
                        <div>
                            ...
                            <p className="text-sm text-gray-500 font-medium">Kelola grup belajar dan wali kelas</p>
                        </div>
                        ...
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="bg-gray-50/50">
                                    <th className="px-8 py-4 text-[10px] font-black text-gray-400 uppercase tracking-widest border-y border-gray-100">Nama Kelas</th>
                                    ...
                                    dataList.map((item) => (
                                        <tr key={item.id} className="group hover:bg-indigo-50/30 transition-colors">
                                            <td className="px-8 py-5">
                                                <span className="text-sm font-bold text-gray-900 bg-indigo-50 text-indigo-700 px-3 py-1 rounded-lg border border-indigo-100">
                                                    {item.name}
                                                </span>
                                            </td>
                                            <td className="px-8 py-5">
                                                <span className="text-sm font-medium text-gray-600">{item.academic_year?.name || '-'}</span>
                                            </td>
                                            <td className="px-8 py-5">
                                                <div className="flex items-center">
                                                    ...
                                                    <span className="text-sm font-semibold text-gray-700">{item.homeroom_teacher?.name || 'Belum diatur'}</span>
                                                </div>
                                            </td>
                                    ...
                                    <tr>
                                        <td colSpan="4" className="px-8 py-20 text-center">
                                            <div className="flex flex-col items-center">
                                                ...
                                                <p className="text-sm font-bold text-gray-400 uppercase tracking-widest">Belum ada data kelas</p>
                                            </div>
                                        </td>
                                    </tr>
                                )}
